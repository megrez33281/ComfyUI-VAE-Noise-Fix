...
def main() -> None:
    ...
    print("    E            Toggle brush edit mode (forces Mask Overlay view)")
    print("                   Left-drag  = add to mask  |  Right-drag = erase from mask")
    print("                   Scroll in edit mode also resizes the brush")
    print("    [ / ]        Decrease / increase brush radius")
    print("    C            Clear all brush edits")
    ...
    print("    S            Save current view (also dumps edited binary mask if any)")
